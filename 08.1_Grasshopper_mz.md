...
>If you stay over the input node of a component for a few moments a window will pop up giving you more information about the type of input which this component expects. By connecting a parameter or the output of another component you can feed data to the input node.
